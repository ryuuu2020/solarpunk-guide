...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = [
    ...
    { path: '/best-base-locations', priority: 0.9, changefreq: 'weekly' as const },
    { path: '/builds', priority: 0.9, changefreq: 'weekly' as const },
    { path: '/tier-list', priority: 0.9, changefreq: 'weekly' as const },
    { path: '/tool-progression', priority: 0.8, changefreq: 'weekly' as const },
