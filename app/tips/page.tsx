    ...
    <div className="min-h-screen bg-field-paper bg-paper-texture">
      <header className="pt-12 pb-6 px-4 lg:px-8 max-w-6xl mx-auto">
        <div className="flex flex-col items-start">
          ...
          <h1 className="font-display text-4xl lg:text-5xl font-bold tracking-tight text-bark leading-none">Survival Tips</h1>
          <p className="font-body text-base text-stone mt-3 max-w-md leading-relaxed italic">30 practical Solarpunk tips verified by veteran community players</p>
        </div>
